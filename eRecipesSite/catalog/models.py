...
class Recipe(models.Model):
    ...
    author = models.ForeignKey('Author', on_delete=models.SET_NULL, null=True) # default is for testing only
    ...
    description = models.TextField(max_length=1000, help_text='Enter a brief description of the recipe', blank=True, null=True)
